...
// to another function in this module!
{
    ...
    // Country code string returned bye GetLocaleInfo
    char  CountryCodeStr [6];

    // get country information
    if (GetLocaleInfo (LOCALE_USER_DEFAULT, LOCALE_ICOUNTRY,
                       CountryCodeStr, sizeof (CountryCodeStr)) > 0) {

        // set country and language
        Country = atoi (CountryCodeStr);
        Language = NLSGetDefaultLanguage (Country);
    }
