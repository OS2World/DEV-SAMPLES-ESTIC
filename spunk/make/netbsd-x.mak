# *****************************************************************************
# *									      *
# *	  SPUNK MAKEFILE for the X Window System under NetBSD using g++       *
# *									      *
...
CFLAGS	= -DNETBSD -x c++ -I /usr/X11/include -fno-implicit-templates -DEXPLICIT_TEMPLATES
...
xresed:		$(LIB) $(RESEDITOBJS)
	$(CC) -g -o xresed $(RESEDITOBJS) $(LIB) -lg -lg++ -lX11
